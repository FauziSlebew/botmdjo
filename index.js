    ...
    jobotz.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=Welcome 👋`)
...
© ⏤͟͟͞𝙁𝙖𝙪𝙯𝙞
  `
                ...
                asa1 = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=Sayonara👋`)
                anunya2 =`
╭━━•›ꪶ ཻུ۪۪ꦽꦼ̷⸙ ━ ━ ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷⸙‹•━━╮
┃╭┈─────────────⩵꙰ཱི࿐
┃╰── ⏤͟͟͞GOOD BYE ──➤ ↶↷
